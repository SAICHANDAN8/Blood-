    ...
    <div class="container mt-4">
        ...
        <form action="" method="post">
            ...
            <div class="form-group col-md-4">
                ...
                <input type="password" class="form-control" name="confirm_password" id="inputPassword" placeholder=" Enter Confirm Password">
            </div>
            <div class="form-group col-md-4">
                <h4>Address</h4>
            ...
            <div class="form-group  col-md-4 ">
                ...
                <button type="submit" class="btn btn-primary" onclick="alert('REGISTER Successfully')">Sign Up</button>
        </form>
    </div>
